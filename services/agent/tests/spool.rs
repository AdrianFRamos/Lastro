...
fn row(capture_id: Uuid) -> OutboxRow {
    OutboxRow {
        ...
        station_signature: [
            0x09, 0x57, 0x9d, 0xe3, 0x9f, 0xbd, 0x81, 0x08, 0xde, 0xa2, 0xfc, 0x89, 0x26, 0x22,
            0x40, 0xc4, 0x5b, 0x20, 0x43, 0xd8, 0x5e, 0x6e, 0x16, 0x85, 0x4d, 0x9b, 0xed, 0x73,
            0x7e, 0x64, 0x26, 0xe1, 0x09, 0xbe, 0x54, 0x8b, 0x3e, 0xb9, 0xd3, 0xba, 0x32, 0x52,
            0xae, 0xba, 0x61, 0xaf, 0x23, 0x0a, 0x18, 0x11, 0x5a, 0xea, 0xf0, 0xb7, 0x47, 0x34,
            0xdf, 0x88, 0xc9, 0x09, 0x55, 0xf9, 0x18, 0x4f,
        ],
...
async fn finalized_row_is_immutable() {
    ...
    assert!(
        sqlx::query("UPDATE outbox SET event_bytes = zeroblob(276) WHERE capture_id = ?")
